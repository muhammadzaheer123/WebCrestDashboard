        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-zinc-400">
              Track your leave requests and check their status.
            </p>
          </div>
            ...
            <div className="space-y-2.5">
              {[
                ...
                >
                  ...
                  <span className={cx("text-sm font-semibold", valueClass)}>
                    {value}
                  </span>
                </div>
              ))}
        ...
        <section className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl">
          ...
          <div className="flex flex-col gap-4 border-b border-white/10 p-5 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-0.5 text-xs text-zinc-400">
                View all your submitted leave requests and HR decisions.
              </p>
            </div>
          ...
          {loading ? (
            <div className="flex items-center justify-center gap-3 py-16 text-zinc-400">
              ...
              <span className="text-sm">Loading your leave requests...</span>
            </div>
          ) : error ? (
                  ...
                  <tbody>
                    {rows.map((item) => (
                      ...
                      >
                        ...
                        <td className="px-5 py-4 text-zinc-300">{item.days}</td>
